...
- Treat `docs/real_annotation_contract.md` as the shared vocabulary for real annotations and schema 0.6 morphology reviews. Schema 0.6 may generate exploratory bundles and clumps, but hidden child or clump-fragment traces are latent provenance, not filament-centerline supervision.
